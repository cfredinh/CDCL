...
def parse_arguments():
    ...
    parser.add_argument('--n_channels', type=int, required=True, default=1, 
    ...
    parser.add_argument('--image_type', type=str, required=False, default="png", 
                        help= 'Size of the updated images.')    
...
def resize(org_path, target_dir, new_dir, size, n_channels):
...
def main(args):
    ...
    Parallel(n_jobs=n_jobs, verbose=1)(delayed(resize)(
        all_img_paths[i], target_dir, new_dir, img_size, n_channels)
